\begin{frame}{Graphs}{Degrees (Valency)}
  ...
  \begin{figure}
    \begin{adjustbox}{width=0.325\linewidth}
      \input{Lecture/Images/Graphs/Degree_Undirected.tikz}
    \end{adjustbox}
...
\begin{frame}{Graphs}{Degrees (Valency)}
  ...
  \begin{figure}
    \begin{adjustbox}{width=0.325\linewidth}
      \input{Lecture/Images/Graphs/Degree_Directed.tikz}
    \end{adjustbox}
...
\begin{frame}{Graphs}{Paths}
  ...
  \begin{columns}
    \begin{column}[b]{0.5\linewidth}
      \begin{figure}
        \begin{adjustbox}{width=0.95\linewidth}
          \input{Lecture/Images/Graphs/Paths_Undirected.tikz}
        \end{adjustbox}
    ...
    \begin{column}[b]{0.5\linewidth}
      \begin{figure}
        \begin{adjustbox}{width=0.95\linewidth}
          \input{Lecture/Images/Graphs/Paths_Directed.tikz}
        \end{adjustbox}
    ...
    \begin{column}[b]{0.5\linewidth}
      \begin{figure}
        \begin{adjustbox}{width=0.8\linewidth}
          \input{Lecture/Images/Graphs/Paths_Weighted.tikz}
        \end{adjustbox}
...
\begin{frame}{Graphs}{Paths}
  ...
  \begin{figure}
    \begin{adjustbox}{width=0.75\linewidth}
      \input{Lecture/Images/Graphs/Paths_Shortest.tikz}
    \end{adjustbox}
...
\begin{frame}{Graphs}{Paths}
  ...
  \begin{figure}
    \begin{adjustbox}{width=0.75\linewidth}
      \input{Lecture/Images/Graphs/Paths_Diameter.tikz}
    \end{adjustbox}
...
\begin{frame}{Graphs}{Connected Components}
  ...
  \begin{figure}
    \begin{adjustbox}{width=0.65\linewidth}
      \input{Lecture/Images/Graphs/Graph_ConnectedComponents.tikz}
    \end{adjustbox}
...
\begin{frame}{Graphs}{Connected Components - Breadth-First Search}
  ...
  \begin{figure}
    \begin{adjustbox}{width=0.95\linewidth}
      \input{Lecture/Images/Graphs/Search_BreadthFirst.tikz}
    \end{adjustbox}
...
\begin{frame}{Graphs}{Connected Components - Depth-First Search}
  ...
  \begin{figure}
    \begin{adjustbox}{width=0.95\linewidth}
      \input{Lecture/Images/Graphs/Search_DepthFirst.tikz}
    \end{adjustbox}
