...
\codeslide{python}{
\begin{frame}{Dynamic Fields}{Implementation 1 - Python}
  \lstinputlisting[
    language=Python,
    basicstyle=\small,
    tabsize=4,
  ...
  ]{Lecture/Code/DynamicField/Impl1/DynamicListImpl1_Part1.py}
\end{frame}
}
...
\begin{frame}{Dynamic Fields}{Implementation 1 - Python}
  \lstinputlisting[
    ...
    emphstyle=\color{blue}
  ]{Lecture/Code/DynamicField/Impl1/DynamicListImpl1_Part2.py}
\end{frame}
}
...
\codeslide{java}{
\begin{frame}{Dynamic Fields}{Implementation 1 - Java}
  \vspace{-0.5em}
  \lstinputlisting[
    language=Java,
    basicstyle=\small,
  ...
  ]{Lecture/Code/DynamicField/Impl1/DynamicFieldImpl1_Part1.java}
\end{frame}
...
\begin{frame}{Dynamic Fields}{Implementation 1 - Java}
  ...
  \lstinputlisting[
    ...
    emph={size,elements},
    emphstyle=\color{java_static}
  ]{Lecture/Code/DynamicField/Impl1/DynamicFieldImpl1_Part2.java}
\end{frame}
}
...
\codeslide{cpp}{
\begin{frame}{Dynamic Fields}{Implementation 1 - C++ - Header}
  \vspace{-0.5em}
  \lstinputlisting[
    language=C++,
    basicstyle=\small,
  ...
  ]{Lecture/Code/DynamicField/Impl1/DynamicFieldImpl1.h}
\end{frame}
%-------------------------------------------------------------------------------

\begin{frame}{Dynamic Fields}{Implementation 1 - C++}
  \vspace{-0.5em}
  \lstinputlisting[
    language=C++,
    basicstyle=\small,
  ...
  ]{Lecture/Code/DynamicField/Impl1/DynamicFieldImpl1_Part1.cpp}
\end{frame}
...
\begin{frame}{Dynamic Fields}{Implementation 1 - C++}
  ...
  \lstinputlisting[
    ...
    emph={size,elements},
    emphstyle=\color{cpp_static}
  ]{Lecture/Code/DynamicField/Impl1/DynamicFieldImpl1_Part2.cpp}
\end{frame}
}
...
\begin{frame}{Dynamic Fields}{Implementation 1}
  ...
  \end{itemize}
  \begin{figure}
    \input{Lecture/Images/DynamicArray/RuntimePlot_Impl1.tikz}
    \vspace{-1.0em}
...
\codeslide{python}{
\begin{frame}{Dynamic Fields}{Implementation 2 - Python}
  \lstinputlisting[
    language=Python,
    basicstyle=\small,
    tabsize=4,
    ...
    emph={DynamicArray, append},
    emphstyle=\color{blue}
  ]{Lecture/Code/DynamicField/Impl2/DynamicListImpl2.py}
\end{frame}
}
...
\codeslide{java}{
\begin{frame}{Dynamic Fields}{Implementation 2 - Java}
  \vspace{-0.5em}
  \lstinputlisting[
    language=Java,
    basicstyle=\small,
    ...
    emph={size,elements},
    emphstyle=\color{java_static}
  ]{Lecture/Code/DynamicField/Impl2/DynamicFieldImpl2.java}
\end{frame}
}
...
\codeslide{cpp}{
\begin{frame}{Dynamic Fields}{Implementation 2 - C++ - Header}
  \vspace{-0.5em}
  \lstinputlisting[
    language=C++,
    basicstyle=\small,
    ...
    emphstyle=\color{cpp_static}
  ]{Lecture/Code/DynamicField/Impl2/DynamicFieldImpl2.h}
\end{frame}
%-------------------------------------------------------------------------------

\begin{frame}{Dynamic Fields}{Implementation 2 - C++}
  \vspace{-0.5em}
  \lstinputlisting[
    language=C++,
    basicstyle=\small,
    ...
    emphstyle=\color{cpp_static},
    morekeywords={nullptr}
  ]{Lecture/Code/DynamicField/Impl2/DynamicFieldImpl2_Part1.cpp}
\end{frame}
...
\begin{frame}{Dynamic Fields}{Implementation 2 - C++}
  ...
  \lstinputlisting[
    ...
    emph={size,elements,memSize},
    emphstyle=\color{cpp_static}
  ]{Lecture/Code/DynamicField/Impl2/DynamicFieldImpl2_Part2.cpp}
\end{frame}
}
...
\begin{frame}{Dynamic Fields}{Implementation 2}
  ...
  \end{itemize}
  \begin{figure}
    \input{Lecture/Images/DynamicArray/RuntimePlot_Impl2.tikz}
    \vspace{-1.0em}
    \caption{Runtime of \textit{DynamicArray}}
...
\begin{frame}{Dynamic Fields}{Implementation 3}
  \lstinputlisting[
    ...
    emph={DynamicArray, append},
    emphstyle=\color{blue}
  ]{Lecture/Code/DynamicField/Impl3/DynamicListImpl3.py}
\end{frame}

%-------------------------------------------------------------------------------

\codeslide{java}{
\begin{frame}{Dynamic Fields}{Implementation 3 - Java}
  \vspace{-0.5em}
  \lstinputlisting[
    language=Java,
    basicstyle=\small,
    ...
    emphstyle=\color{java_static},
    breaklines=false
  ]{Lecture/Code/DynamicField/Impl3/DynamicFieldImpl3.java}
\end{frame}
}
...
\codeslide{cpp}{
\begin{frame}{Dynamic Fields}{Implementation 3 - C++}
  \vspace{-0.5em}
  \lstinputlisting[
    language=C++,
    basicstyle=\small,
    ...
    emphstyle=\color{cpp_static},
    morekeywords={nullptr}
  ]{Lecture/Code/DynamicField/Impl3/DynamicFieldImpl3.cpp}
\end{frame}
}
...
\begin{frame}{Dynamic Fields}{Implementation 3}
  ...
  \end{itemize}
  \begin{figure}
    \input{Lecture/Images/DynamicArray/RuntimePlot_Impl3.tikz}
    \vspace{-1.0em}
    \caption{Runtime of \textit{DynamicArray}}
