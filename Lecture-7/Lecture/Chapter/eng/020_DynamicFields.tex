...
\begin{frame}{Dynamic Fields}{Implementation 1 - Java}
  ...
  ]{Lecture/Code/DynamicFieldImpl1_Part1.java}
\end{frame}
...
\begin{frame}{Dynamic Fields}{Implementation 1 - Java}
  ...
  \lstinputlisting[
    ...
    emph={size,elements},
    emphstyle=\color{java_static}
  ]{Lecture/Code/DynamicFieldImpl1_Part2.java}
\end{frame}
}
...
\begin{frame}{Dynamic Fields}{Implementation 1 - C++ - Header}
  ...
  ]{Lecture/Code/DynamicFieldImpl1.h}
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}{Dynamic Fields}{Implementation 1 - C++}
  ...
  ]{Lecture/Code/DynamicFieldImpl1_Part1.cpp}
\end{frame}
...
\begin{frame}{Dynamic Fields}{Implementation 1 - C++}
  ...
  \lstinputlisting[
    ...
    emph={size,elements},
    emphstyle=\color{cpp_static}
  ]{Lecture/Code/DynamicFieldImpl1_Part2.cpp}
\end{frame}
}
