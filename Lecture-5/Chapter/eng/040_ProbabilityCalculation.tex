...
\begin{frame}{Universal Hashing}{Probability Calculation}
 ...
 \item<6-> Example rolling twice: \rlap{\onslide<7->{\color{Mittel-Blau}$\E(X) = 2 \cdot \frac{1}{36} + 3 \cdot \frac{2}{36}    + \dots + 12 \cdot \frac{1}{36} = 7$}}
   \end{itemize}
\end{frame}
...
%%% Local Variables: 
%%% mode: latex 
%%% TeX-master: "~/TeX/TeXinput/Scripts/Algo-Data-EMS/Rolf-2016/AlgoDat/Lecture-5/Lecture.tex" 
%%% End: 
%%% ===================================================================