\subsection{Hash Map}
%\definecolor{inkscapeNavy}{HTML}{000080}
%\definecolor{inkscapeGreen}{HTML}{008000}
%\definecolor{inkscapeMaroon}{HMTL}{800000}
...
\begin{frame}{Associative Arrays}{The Hash Map}
  ...
  \begin{itemize}
    ...
    \onslide <3-> \item We need an array {\color{Mittel-Blau}T} with {\color{Mittel-Blau}5} elements.\\
          A "hashtable" with 5 "buckets"
    \onslide <4-> \item The element with the key {\color{Mittel-Blau}x} is stored in {\color{Mittel-Blau}$T[h(x)]$} 
  \end{itemize}
\end{frame}
...
\begin{frame}{Associative Arrays}{The Hash Map}
  ...
  \begin{itemize}
    ...
    \item<2->
    \small insert(3904433,"A"):
    $\hspace*{0.0em} h(3904433) = 3$
    $\hspace*{-0.1em} \Rightarrow$
    T[3] = {\color{inkscapeGreen}(3904433, "A")}
    \item<3->
    \small insert(312692, "B"):
    $\hspace*{0.0em} h(312692) = 2$
    $\hspace*{-0.1em} \Rightarrow$
    T[2] = {\color{inkscapeMaroon}(312692, "B")}
    \item<4->
    \small insert(5148949, "C"):
    $\hspace*{0.0em} h(5148949) = 4$
    $\hspace*{-0.1em} \Rightarrow$
  ...
  \caption{Hashtable T}
  \centering
\only<1-1>{\includegraphics[width=0.6\textwidth]{Images/Bucket1.eps}}%
\only<2-2>{\includegraphics[width=0.6\textwidth]{Images/Bucket2.eps}}%
\only<3-3>{\includegraphics[width=0.6\textwidth]{Images/Bucket3.eps}}%
\only<4->{\includegraphics[width=0.6\textwidth]{Images/Bucket4.eps}}
  \end{figure}
\end{frame}
...
\begin{frame}{Associative Arrays}{Hash Collisions}
  ...
  \end{itemize}
    \vspace*{-1.0em}
    \begin{figure}
    \onslide <3->\caption{Hashtable T}
    \centering
    \only<1-3>{\includegraphics[width=0.6\textwidth]{Images/Bucket4.eps}}
    \only<4-4>{\includegraphics[width=0.6\textwidth]{Images/Bucket5.eps}}
  \end{figure}
\end{frame}
