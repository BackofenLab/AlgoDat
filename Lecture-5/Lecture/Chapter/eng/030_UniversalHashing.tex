...
\begin{frame}{Universal Hashing}{Idea}
  ...
  \begin{columns}
    \begin{column}{0.33\linewidth}
      \begin{figure}[!h]
        \begin{adjustbox}{height=0.8\linewidth}
          \input{Lecture/Images/UniversalHashing/Hash_1_Crossing.tikz}
        \end{adjustbox}
        \caption{Hash func. 1}
    ...
    \begin{column}{0.33\linewidth}
      \begin{figure}[!h]
        \begin{adjustbox}{height=0.8\linewidth}
          \input{Lecture/Images/UniversalHashing/Hash_2_Normal.tikz}
        \end{adjustbox}
        \caption{Hash func. 2}
    ...
    \begin{column}{0.33\linewidth}
      \begin{figure}[!h]
        \begin{adjustbox}{height=0.8\linewidth}
          \input{Lecture/Images/UniversalHashing/Hash_3_Colliding.tikz}
        \end{adjustbox}
        \caption{Hash func. 2}
...
\begin{frame}{Universal Hashing}{Definition}
  ...
  \begin{figure}[!b]%
    \begin{adjustbox}{height=0.35\linewidth}%
      \input{Lecture/Images/UniversalHashing/HashFunction.tikz}%
    \end{adjustbox}
    \vspace*{-1.0em}%
    ...
    \begin{column}{0.5\linewidth}
      \begin{figure}[!t]%
        \begin{adjustbox}{width=\linewidth}
          \input{Lecture/Images/UniversalHashing/HashUniverse.tikz}%
        \end{adjustbox}
...
\begin{frame}{Universal Hashing}{Definition}
  \begin{columns}
    ...
    \begin{column}{0.5\linewidth}
      \begin{figure}[!h]%
        \begin{adjustbox}{width=\linewidth}%
          \input{Lecture/Images/UniversalHashing/HashFunctionToBucket.tikz}%
        \end{adjustbox}
