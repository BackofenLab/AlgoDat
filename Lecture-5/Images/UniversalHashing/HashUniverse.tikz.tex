...
\draw[text=Mittel-Blau] (-2.75, 10.0) node[align=center](U) {\Huge$\mathbb{U}$};

\draw (5.0, 8.5) node[anchor=west](T_Text) {\Huge Hashtable};
\draw[text=Mittel-Blau] (5.5, 7.5) node[align=center](T) {\Huge T};
...
\draw[text=Mittel-Blau] (-3.0, 6.5) node[anchor=east](x) {\Huge x};
\draw[text=Mittel-Blau] (-3.0, 3.5) node[anchor=east](y) {\Huge y};
\foreach \y in {3, -3}{
  \draw[key_n]
  (-2.5, 0.5*\y + 5.25) -- (-3.0, 0.5*\y + 5.25) --
  (-3.0, 0.5*\y + 4.75) -- (-2.5, 0.5*\y + 4.75) --
