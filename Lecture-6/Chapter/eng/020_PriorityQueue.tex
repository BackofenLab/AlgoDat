...
\begin{frame}{Priority Queue}{Java}
  ...
  ]{Lecture/Code/PriorityQueuePart1.java}
\end{frame}
...
\begin{frame}{Priority Queue}{Java}
  \lstinputlisting[
    ...
    emph={q,i2,i3,i4},
    emphstyle=\color{java_variable}
  ]{Lecture/Code/PriorityQueuePart2.java}
\end{frame}
}
...
\begin{frame}{Priority Queue}{C++}
  \lstinputlisting[
    ...
    morekeywords={endl},
    escapechar={@}
  ]{Lecture/Code/PriorityQueuePart1.cpp}
\end{frame}
...
\begin{frame}{Priority Queue}{C++}
  ...
  \lstinputlisting[
    ...
    morekeywords={endl},
    escapechar={@}
  ]{Lecture/Code/PriorityQueuePart2.cpp}
\end{frame}
}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \begin{figure}[!h]
    \begin{adjustbox}{height=0.3\linewidth}
      \input{Lecture/Images/GenericHeap.tikz}%
    \end{adjustbox}
    \vspace{-0.75em}
...
\begin{frame}{Priority Queue}{Implementation}
 \begin{figure}[!h]%
   ...
   \begin{minipage}[b]{0.4\linewidth}%
     \input{Lecture/Images/PriorityQueue/Heap.tikz}%
    \end{minipage}
    \hfill
...
\begin{frame}{Priority Queue}{Implementation - Insertion}
  ...
  \begin{figure}[!h]
    ...
    \begin{adjustbox}{height=0.275\linewidth}
      \input{Lecture/Images/PriorityQueue/Heap_Insert.tikz}%
    \end{adjustbox}
    %    \vspace{-0.5em}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \begin{figure}[!h]
    \begin{adjustbox}{height=0.275\linewidth}
      \input{Lecture/Images/PriorityQueue/Heap_Peek.tikz}%
    \end{adjustbox}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \begin{figure}[!h]
    \begin{adjustbox}{height=0.275\linewidth}
      \input{Lecture/Images/PriorityQueue/Heap_PrePop.tikz}%
    \end{adjustbox}
    \hspace{0.5em}\raisebox{3.0em}{
      $\stackrel{\color{Mittel-Blau}\texttt{deleteMin}}{\Rightarrow}$
    }\hspace{-1.5em}
    \begin{adjustbox}{height=0.275\linewidth}
      \input{Lecture/Images/PriorityQueue/Heap_PostPop.tikz}%
    \end{adjustbox}
    %    \vspace{-0.5em}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \end{itemize}
    \begin{figure}[!h]
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueue/Heap_PreChangeKey.tikz}%
      \end{adjustbox}
      \hspace{0.25em}\raisebox{3.0em}{
        $\stackrel{\color{Mittel-Blau}\texttt{changeKey}}{\Rightarrow}$
      }\hspace{-1.5em}
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueue/Heap_PostChangeKey.tikz}%
      \end{adjustbox}
      %    \vspace{-0.5em}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \end{itemize}
    \begin{figure}[!h]
      ...
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueue/Heap_PostChangeKey2.tikz}%
      \end{adjustbox}
      %    \vspace{-0.5em}
      %    \caption{Changing the key of an element}%
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \end{itemize}
    \begin{figure}[!h]
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueue/Heap_PreRemove.tikz}%
      \end{adjustbox}
      \hspace{0.5em}\raisebox{3.0em}{
        $\stackrel{\color{Mittel-Blau}\texttt{remove}}{\Rightarrow}$
      }\hspace{-1.0em}
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueue/Heap_PostRemove.tikz}%
      \end{adjustbox}
      %    \vspace{-0.5em}
    ...
    \begin{columns}%
      \begin{column}{0.45\linewidth}%
        \begin{adjustbox}{width=\linewidth}%
          \input{Lecture/Images/PriorityQueue/HeapRepairDown_First.tikz}%
        \end{adjustbox}%
      \end{column}%
      \begin{column}{0.45\linewidth}%
        \begin{adjustbox}{width=\linewidth}%
          \input{Lecture/Images/PriorityQueue/HeapRepairDown_Second.tikz}%
        \end{adjustbox}%
      \end{column}%
    \end{columns}%
  ...
  \begin{center}
    \begin{figure}[!h]%
      \begin{columns}%
        ...
        \begin{column}{0.45\linewidth}%
          \begin{adjustbox}{width=\linewidth}%
            \input{Lecture/Images/PriorityQueue/HeapRepairDown_Third.tikz}%
          \end{adjustbox}%
        \end{column}%
      \end{columns}%
      \caption{Repairing the heap downwards}%
  ...
  \begin{center}
    \begin{figure}[!h]%
      \begin{columns}%
        \begin{column}{0.45\linewidth}%
          \begin{adjustbox}{width=\linewidth}%
            \input{Lecture/Images/PriorityQueue/HeapRepairUp_First.tikz}%
          \end{adjustbox}%
        \end{column}%
        \begin{column}{0.45\linewidth}%
          \begin{adjustbox}{width=\linewidth}%
            \input{Lecture/Images/PriorityQueue/HeapRepairUp_Second.tikz}%
          \end{adjustbox}%
        \end{column}%
      \end{columns}%
  ...
  \begin{center}
    \begin{figure}[!h]%
      \begin{columns}%
        ...
        \begin{column}{0.45\linewidth}%
          \begin{adjustbox}{width=\linewidth}%
            \input{Lecture/Images/PriorityQueue/HeapRepairUp_Third.tikz}%
          \end{adjustbox}%
        \end{column}%
      \end{columns}%
      \caption{Repairing the heap upwards}%
...
\begin{frame}{Priority Queue}{Implementation - Priority Queue Item - Python}
  ...
  ]{Lecture/Code/PriorityQueueItem.py}
\end{frame}
}
...
\begin{frame}{Priority Queue}{Implementation - Priority Queue Item - Java}
  ...
  ]{Lecture/Code/PriorityQueueItem.java}
\end{frame}
}
...
\begin{frame}{Priority Queue}{Implementation - Priority Queue Item - C++}
  \lstinputlisting[
    ...
    morekeywords={endl},
    escapechar={@}
  ]{Lecture/Code/PriorityQueueItem.cpp}
\end{frame}
}
