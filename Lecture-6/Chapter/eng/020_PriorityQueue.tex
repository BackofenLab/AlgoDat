  ...
  \begin{itemize}
    ...
    \item<4->
      ...
      \begin{itemize}
        ...
        \item<5->
          Therefor each element has to store its current position in the heap.
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Priority Queue}{Application Example}
  ...
  \begin{itemize}
    \item<7->
      For example Dijkstra's algorithm for compution the shortest path ($\leftarrow$ following lecture)
    \item<8->
