...
%TODO(Tobias): Use tabbed environment
\begin{frame}{Priority Queue}{Introduction}
  \textbf{Definition:}
  \begin{itemize}
    \item
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \begin{figure}[!h]
    \begin{adjustbox}{height=0.3\textwidth}
      \input{Lecture/Images/Heap.tikz}%
    \end{adjustbox}
    \vspace{-0.75em}
...
\begin{frame}{Priority Queue}{Implementation}
 \begin{figure}[!h]%
   ...
   \begin{minipage}[b]{0.4\textwidth}%
     \input{Lecture/Images/PriorityQueueHeap.tikz}%
    \end{minipage}
    \hfill
...
\begin{frame}{Priority Queue}{Implementation - Insertion}
  ...
  \begin{figure}[!h]
    ...
    \end{adjustbox}
    \raisebox{3.0em}{
      $\stackrel{\color{Mittel-Blau}\texttt{
          insert(1, {\color{green2}X})
        }}{\Rightarrow}$
      }\hspace{-1.5em}
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueueHeapInsert.tikz}%
      \end{adjustbox}
      %    \vspace{-0.5em}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \begin{figure}[!h]
    \begin{adjustbox}{height=0.275\linewidth}
      \input{Lecture/Images/PriorityQueueHeapPeek.tikz}%
    \end{adjustbox}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \begin{figure}[!h]
    \begin{adjustbox}{height=0.275\linewidth}
      \input{Lecture/Images/PriorityQueueHeapPrePop.tikz}%
    \end{adjustbox}
    \hspace{0.5em}\raisebox{3.0em}{
      $\stackrel{\color{Mittel-Blau}\texttt{deleteMin}}{\Rightarrow}$
    }\hspace{-1.5em}
    \begin{adjustbox}{height=0.275\linewidth}
      \input{Lecture/Images/PriorityQueueHeapPostPop.tikz}%
    \end{adjustbox}
    %    \vspace{-0.5em}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \end{itemize}
    \begin{figure}[!h]
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueueHeapPreChangeKey.tikz}%
      \end{adjustbox}
      \hspace{0.25em}\raisebox{3.0em}{
        $\stackrel{\color{Mittel-Blau}\texttt{changeKey}}{\Rightarrow}$
      }\hspace{-1.5em}
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueueHeapPostChangeKey.tikz}%
      \end{adjustbox}
      %    \vspace{-0.5em}
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \end{itemize}
    \begin{figure}[!h]
      ...
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueueHeapPostChangeKey2.tikz}%
      \end{adjustbox}
      %    \vspace{-0.5em}
      %    \caption{Changing the key of an element}%
...
\begin{frame}{Priority Queue}{Implementation}
  ...
  \end{itemize}
    \begin{figure}[!h]
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueueHeapPreRemove.tikz}%
      \end{adjustbox}
      \hspace{0.5em}\raisebox{3.0em}{
        $\stackrel{\color{Mittel-Blau}\texttt{remove}}{\Rightarrow}$
      }\hspace{-1.0em}
      \begin{adjustbox}{height=0.275\linewidth}
        \input{Lecture/Images/PriorityQueueHeapPostRemove.tikz}%
      \end{adjustbox}
      %    \vspace{-0.5em}
      ...
      \begin{columns}%
        \begin{column}{0.45\textwidth}%
          \begin{minipage}{\textwidth}%
            \begin{center}%
              \input{Lecture/Images/HeapRepairDown_First.tikz}%
            \end{center}%
          \end{minipage}%
        \end{column}%
        \begin{column}{0.45\textwidth}%
          \begin{minipage}{\textwidth}%
            \begin{center}%
              \input{Lecture/Images/HeapRepairDown_Second.tikz}%
            \end{center}%
          \end{minipage}%
        \end{column}%
      \end{columns}%
    ...
    \begin{figure}[!h]%
      \begin{columns}%
        ...
        \begin{column}{0.45\textwidth}%
          \begin{minipage}{\textwidth}%
            \begin{center}%
              \input{Lecture/Images/HeapRepairDown_Third.tikz}%
            \end{center}%
          \end{minipage}%
        \end{column}%
      \end{columns}%
    ...
    \begin{figure}[!h]%
      \begin{columns}%
        \begin{column}{0.45\textwidth}%
          \begin{minipage}{\textwidth}%
            \begin{center}%
              \input{Lecture/Images/HeapRepairUp_First.tikz}%
            \end{center}%
          \end{minipage}%
        \end{column}%
        \begin{column}{0.45\textwidth}%
          \begin{minipage}{\textwidth}%
            \begin{center}%
              \input{Lecture/Images/HeapRepairUp_Second.tikz}%
            \end{center}%
          \end{minipage}%
        \end{column}%
      \end{columns}%
    ...
    \begin{figure}[!h]%
      \begin{columns}%
        ...
        \begin{column}{0.45\textwidth}%
          \begin{minipage}{\textwidth}%
            \begin{center}%
              \input{Lecture/Images/HeapRepairUp_Third.tikz}%
            \end{center}%
          \end{minipage}%
        \end{column}%
      \end{columns}%
