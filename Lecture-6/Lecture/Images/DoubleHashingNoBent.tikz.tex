...
\draw (5.5, -0.75) node[hash_text_final] {%
  \large%
  ${\color{Mittel-Gruen}h(s_2, 1)}$%
};%
\draw (8.5, -0.75) node[hash_text_final] {%
  \large%
  ${\color{Mittel-Gruen}h(s_2, 2)}$%
};%
\draw (11.5, -0.75) node[hash_text_final] {%
  \large%
  ${\color{Mittel-Gruen}h(s_2, 2)}$%
};%
...
\draw (8.5, -0.5) edge[->, arrow_taken] (8.5, -0.1);
\draw (11.5, -0.5) edge[->, arrow_taken] (11.5, -0.1);
\end{tikzpicture}%
\end{adjustbox}%