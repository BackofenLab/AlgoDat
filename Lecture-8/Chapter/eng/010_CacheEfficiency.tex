...
\begin{frame}{Cache Efficiency}{Linear Order - Python}
  ...
  ]{Lecture/Code/Caching/CacheLinear_Part1.py}
\end{frame}
...
\begin{frame}{Cache Efficiency}{Linear Order - Python}
  ...
  \lstinputlisting[
    ...
    emph={run},
    emphstyle=\color{blue}
  ]{Lecture/Code/Caching/CacheLinear_Part2.py}
\end{frame}
}
...
%  ]{Lecture/Code/Caching/CacheLinear.java}
%\end{frame}
%}
%
%%-------------------------------------------------------------------------------
...
%    morekeywords={endl},
%    escapechar={@}
%  ]{Lecture/Code/Caching/CacheLinear.cpp}
%\end{frame}
%}
...
\begin{frame}{Cache Efficiency}{Linear Order}
  \begin{figure}
    \input{Lecture/Images/Caching/SumLinear_Plot.tikz}
    \vspace{-1.0em}
...
\begin{frame}{Cache Efficiency}{Random Order - Python}
  ...
  \lstinputlisting[
    ...
    emph={init},
    emphstyle=\color{blue}
  ]{Lecture/Code/Caching/CacheRandom.py}
\end{frame}
}
...
\begin{frame}{Cache Efficiency}{Random Order}
  \begin{figure}
    \input{Lecture/Images/Caching/SumRandom_Plot.tikz}
    \vspace{-1.0em}
...
\begin{frame}{Cache Efficiency}{CPU Cache}
  ...
  \begin{figure}
    \begin{adjustbox}{width=\linewidth}
      \input{Lecture/Images/Caching/CacheHirarchy.tikz}
    \end{adjustbox}
...
\begin{frame}{Cache Efficiency}{Block Operations}
  ...
  \begin{figure}%
    \begin{adjustbox}{width=\linewidth}%
      \input{Lecture/Images/Caching/CacheBlocks.tikz}%
    \end{adjustbox}%
...
\begin{frame}{Cache Efficiency}{Block Operations}
  ...
  \begin{figure}%
    \begin{adjustbox}{width=\linewidth}%
      \input{Lecture/Images/Caching/MemoryLocality.tikz}%
    \end{adjustbox}%
...
\begin{frame}{Cache Efficiency}{Block Operations - Linear Order}
  ...
  \begin{figure}%
    \begin{adjustbox}{width=\linewidth}%
      \input{Lecture/Images/Caching/MemoryLocality_Linear.tikz}%
    \end{adjustbox}%
...
\begin{frame}{Cache Efficiency}{Block Operations - Random Order}
  ...
  \begin{figure}%
    \begin{adjustbox}{width=\linewidth}%
      \input{Lecture/Images/Caching/MemoryLocality_Random.tikz}%
    \end{adjustbox}%
...
\begin{frame}{Cache Efficiency}{Block Operations - QuickSort}
  ...
  \begin{figure}%
    \begin{adjustbox}{width=\linewidth}%
      \input{Lecture/Images/Caching/QuickSort_Pivot.tikz}%
    \end{adjustbox}%
...
\begin{frame}{Cache Efficiency}{Block Operations - QuickSort - Python}
  ...
  \lstinputlisting[
    ...
    emph={quicksort},
    emphstyle=\color{blue}
  ]{Lecture/Code/Caching/QuickSort_Part1.py}
\end{frame}
...
\begin{frame}{Cache Efficiency}{Block Operations - QuickSort - Python}
  ...
  \lstinputlisting[
    ...
    emph={quicksort},
    emphstyle=\color{blue}
  ]{Lecture/Code/Caching/QuickSort_Part2.py}
\end{frame}
}
...
\begin{frame}{Cache Efficiency}{Block Operations - QuickSort}
  \begin{figure}%
    \begin{adjustbox}{width=\linewidth}%
      \input{Lecture/Images/Caching/MemoryLocality_QuickSort.tikz}%
    \end{adjustbox}%
