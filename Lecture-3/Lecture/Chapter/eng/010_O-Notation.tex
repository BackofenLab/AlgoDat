    ...
    \begin{column}{0.9\textwidth}
      \begin{figure}[!h]
        \includegraphics[width=\linewidth]
          {Lecture/Images/BigONotationRuntime.png}
...
\begin{frame}{$\Omega$-Notation}{Examples}
  ...
  \begin{columns}
    \begin{column}{0.9\textwidth}
      \begin{figure}[!h]
        \includegraphics[width=\linewidth]
        {Lecture/Images/OmegaNotationRuntime.png}
        \caption{Runtime of two algorithms $f_1, f_2$}
...
%ToDo: Is this figure really needed / helpful?

%\begin{frame}{O-Notation Definition}
%	\textbf{Big Theta-Notation:}\\
%	Include Graphics for Big Theta-Notation 
%	(For reference see Lecture3(Power Point) Slide 15)
%\end{frame}
    ...
    $\begin{array}{c}
      \begin{aligned}
        ...
        & \Rightarrow & \lim_{n \to \infty} \frac{f(n)}{g(n)} &= \; L &&
          \hspace*{1.5em}\text{For some } L \text{ (Limit)}\in \mathbb{R}
      \end{aligned}\\
      \\
      \begin{aligned}
