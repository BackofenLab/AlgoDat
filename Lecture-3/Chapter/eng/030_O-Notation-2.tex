...
\begin{frame}{$\mathcal{O}$-Notation}{Calculation Rules}
  \begin{itemize}
    \item
      ...
      \begin{eqnarray*}
        f & \in & \mathcal{O} (f)\\
        C \cdot \mathcal{O} (f) & = & \mathcal{O} (f)\\
        \mathcal{O} (f + C) & = & \mathcal{O} (f)
      \end{eqnarray*}
    \item
      Addition:
      \begin{eqnarray*}
...
\begin{frame}{$\mathcal{O}$-Notation}{Discussion}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item
        B has the runtime $g(n) = 2 \, n \, \log_2 n$
    \end{itemize}
    \item
      ...
      \begin{itemize}
        ...
        \item
          $\Rightarrow$
          There is an $n_0$ for that $n \geq n_0\!: \; f(n) \leq g(n)$
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}<presentation>{Additional Figure}
  \begin{itemize}
  \item
