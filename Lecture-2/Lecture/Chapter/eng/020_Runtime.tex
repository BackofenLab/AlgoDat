...
\begin{frame}{Runtime example 1/2}
  \begin{figure}[!h]
    \includegraphics[width=\linewidth]{Lecture/Images/SquaredRuntime.png}%
    \caption{Squared runtime of different functions}%
...
\begin{frame}{Runtime example 2/2}
  \begin{itemize}
    \item
    ...
    \item
      ...
      \end{itemize}
    \item
      \textbf{Squared runtime = \enquote{big} problems unsolvable}
  \end{itemize}
\end{frame}